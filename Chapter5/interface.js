...
var naruto = new Ninja("Naruto", "Uzumaki", "Genin");
var inari = {FirstName: "Inari", Occupation: "Bridge Builder", ThrowKunai: function(){}};
var tonton = {FirstName: "Ton-Ton", Species: "Pig"};
console.log(ISquadMember.IsImplementedBy(naruto));
console.log(ISquadMember.IsImplementedBy(inari));
console.log(ISquadMember.IsImplementedBy(tonton));
